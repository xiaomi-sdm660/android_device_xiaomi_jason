...
patchelf --replace-needed libminikin.so libminikip.so "$DEVICE_BLOB_ROOT"/vendor/lib/libMiCameraHal.so
patchelf --replace-needed libminikin.so libminikip.so "$DEVICE_BLOB_ROOT"/vendor/lib/hw/camera.sdm660.so
